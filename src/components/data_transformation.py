...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(f"Pipeline object: {preprocessing_obj}")

            logging.info(f"Transformed input feature array: {input_feature_train_arr}")
            ...
            logging.info(f"Shape of target_train_arr after reshaping: {target_train_arr.shape}")
            logging.info(f"Shape of target_test_arr after reshaping: {target_test_arr.shape}")

            # Now we can concatenate the input features with the target arrays
            ...
            logging.info(f"Shape of train_arr: {train_arr.shape}")  # Expecting (81116, 144)
            logging.info(f"Shape of test_arr: {test_arr.shape}")  # Expecting (20279, 144)
